...
function Register() {
    ...
    return (
        <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 ">
            ...
            <div className="mx-auto max-w-2xl text-center items-end justify-items-end flex-col ">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Registration</h2>
                <p className="mt-2 text-lg leading-8 text-gray-600">
                    Complete to member of we
                </p>
            </div>
            ...
            <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20 " onSubmit={handleSubmit}>
                ...
                <div className="mt-10 items-center justify-center text-center gap-1">
                    <button
                        type="submit"
                    ...
                    <p className="m-1">Have account ?</p>
